...
export const metadata = {
  title: 'Iniciar Sesión | Michaucha',
  description: 'Accede a tu cuenta de control de gastos.',
};
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-white text-3xl font-bold">Mis chauchas</h1>
          <p className="text-slate-500 text-sm mt-1">Control de gastos personales</p>
        </div>
